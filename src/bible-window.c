...
G_DEFINE_FINAL_TYPE (BibleWindow, bible_window, ADW_TYPE_APPLICATION_WINDOW)

static void
bible_window_class_init (BibleWindowClass *klass)
{
...
static void
bible_window_init (BibleWindow *self)
{
